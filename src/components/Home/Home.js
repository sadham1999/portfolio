          ...
          <Row>
            <Col md={7} className="home-header">
              ...
              <h1 className="heading-name">
                I'M
                <strong className="main-name"> SADHAM HUSSAIN </strong>
              </h1>
...
2 years of experience</span> specializing in BackendDevelopment with <span className="purple">Laravel Framework.</span>  
